...
import { LoginScreen, HomeScreen, RegistrationScreen, ChatScreen, HousesScreen, NotificationScreen } from './src/screens';
        ...
        { user ? (
          <>
            ...
            <Stack.Screen name="Notifications" options={{
              ...
              {props => <NotificationScreen {...props} extraData={user} />}
            </Stack.Screen>
          </>
        ) : (
          <>
